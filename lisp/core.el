...
(use-package emacs
  ...
  ;; Emacs will defer fontification until you stop typing. In practice
  ;; you never notice the delay – the highlighting catches up instantly
  ;; – but scrolling and typing may feel smoother.
  (setq redisplay-skip-fontification-on-input t)

  ;; remove duplicates from kill rings
